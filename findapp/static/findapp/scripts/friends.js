...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var rotatables = document.querySelectorAll('.rotatable');
  fishes.forEach(function(fish, index) {
    var rotate = rotatables[index];
    ...
    rotate.style.animation = `rotate ${randomDuration}s cubic-bezier(0.9, 1, 0.3, 0.75) 0s infinite normal`;
  });
